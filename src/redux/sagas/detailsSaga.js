...
function* allDetail(action) {
    try {
        ...
        console.log('Error in all toys details saga:', err)
    }
};//end allDetail

//generator for buy Details
function* buyDetails(action) {
    console.log('-----> in buyToys');
    try {
        ...
        console.log('Error in buy toys saga:', err);
    }
};//end buyDetails page
...
function* sellDetails(action) {
    try {
        ...
        console.log('Error in sell toys saga:', err)
    }
};//end sellDetails
...
function* tradeDetail(action) {
    ...
    try {
        //axios get request and send our toy id as params.
