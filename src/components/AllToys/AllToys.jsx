...
class AllToys extends Component {
    ...
    handleClick = (toy) => {
        this.props.history.push(`/alltoys/details/${toy.post_id}`)
    };
    ...
    render() {
        ...
        return (
            <Box className={classes.page}>
                <Typography variant="h3" className={classes.title}>All Toys</Typography>
...
export default connect(putPropsOnState)(withStyles(styles)(AllToys));
