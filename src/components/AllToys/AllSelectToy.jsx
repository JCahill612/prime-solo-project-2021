...
class AllSelectToy extends Component {

    componentDidMount() {
        console.log('AllSelectToy MOUNTED');
        this.props.dispatch({
                    ...
                    return (
                        <Card className={classes.card} variant="outlined" key="toy.post_id">
                            ...
                            <CardActionArea>
                                ...
                                <CardActions>
                                    <Link to="/alltoys"><Button className={classes.button} variant="outlined">Back To List</Button></Link>
                                </CardActions>
                            </CardActionArea>
                        </Card>
                    )
...
export default connect(putPropsOnState)(withStyles(styles)(AllSelectToy));